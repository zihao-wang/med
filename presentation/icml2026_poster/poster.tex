  ...
  \begin{posterbox}
    ...
    \begin{posterbox}[defblock]
      ...
      \begin{itemize}[label=\textbullet,leftmargin=0.48in,labelsep=0.12in,itemsep=0.02in,topsep=0.02in,parsep=0pt]
        ...
        The minimal dimension of embeddable space $\mathbb{R}^d$.
      \end{itemize}
      \end{center}
    \end{posterbox}
...
\begin{minipage}[t]{0.315\linewidth}
  ...
  \begin{posterbox}
    ...
    \begin{posterbox}[witnessblock]
      ...
      \]
      Note that $P_S^2$ has degree $2k$, so we can select $u_S$ as the
      coefficient vector of $-P_S^2(t)$, then:
      \[
        s(v_i,u_S) = \langle v_i,u_S\rangle = -P_S^2(t_i) \begin{cases}
          =0, & i\in S,\\
          >0, & j\notin S.
        \end{cases}
      \]
    ...
    % @codex find a new block describing the theory results abour RMED,
    % states something like k < MED < RMED(...) < Gaussian witness...

    \begin{posterbox}[takeawayblock, height=1.25in, valign=center]
      \centering{\SubheadFont Robust MED brings back $m$; Gaussian witness pays only $\log m$.}
    \end{posterbox}
  \end{posterbox}
\end{minipage}\hfill
\begin{minipage}[t]{0.315\linewidth}
  ...
  \begin{posterbox}
    ...
    \begin{posterbox}[resultblock]
      ...
      \begin{center}
        \tightinclude[width=0.95\linewidth,height=5.05in,keepaspectratio]{../../paper/figures/limit_retrieval_limit.pdf}
      \end{center}
      \vspace{0.04in}
      \begin{center}
        \tightinclude[width=0.95\linewidth,height=5.05in,keepaspectratio]{../../paper/figures/limit_retrieval_limit_small.pdf}
      \end{center}
      \vspace{0.04in}
      \begin{center}
        {\TableFont
      ...
      \end{center}
      \vspace{0.02in}
      Vanilla token sums use no labels and no handcrafted phrases,
